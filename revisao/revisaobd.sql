...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12-Ago-2022 às 13:36
...
(1, 'etecmcm@email.com', 'SP', 'ETEC MCM'),
(2, 'etecmcm@email.com', 'SP', 'ETECMCM'),
(3, 'MC', 'cr', 'Cristiano Ronaldo'),
(4, 'lionelmessi@email.com', 'BA', 'Lionel Messi');
